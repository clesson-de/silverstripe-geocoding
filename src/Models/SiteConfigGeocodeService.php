...
/**
 * Join table for SiteConfig → GeocodingService (geocode method).
 *
 * Links a GeocodingService to SiteConfig for the geocode method,
 ...
 * @subpackage Models
 */
class SiteConfigGeocodeService extends DataObject
{

    /**
     * @inheritdoc
     */
    private static string $table_name = 'Geocoding_SiteConfig_GeocodeService';
     ...
     * @inheritdoc
     */
    private static string $default_sort = '"Geocoding_SiteConfig_GeocodeService"."Sort" ASC';
