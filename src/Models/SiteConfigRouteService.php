...
/**
 * Join table for SiteConfig → GeocodingService (route method).
 *
 * Links a GeocodingService to SiteConfig for the route method,
 ...
 * @subpackage Models
 */
class SiteConfigRouteService extends DataObject
{

    /**
     * @inheritdoc
     */
    private static string $table_name = 'Geocoding_SiteConfig_RouteService';
     ...
     * @inheritdoc
     */
    private static string $default_sort = '"Geocoding_SiteConfig_RouteService"."Sort" ASC';
